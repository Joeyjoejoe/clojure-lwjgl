(ns clopengl.engine.utilities.transformations
...
(defn make
  ([transformation args]
	(m/as-vector (apply (resolve (symbol (str "clopengl.engine.utilities.transformations/" transformation))) args)))
  ([transformation args vectorz]
	(apply (resolve (symbol (str "clopengl.engine.utilities.transformations/" transformation))) args)))
